...
program
  ...
  .addHelpText(
    ...
    [
      ...
      "",
      "SSL connection (auto-enabled for remote hosts):",
      "  SSL is automatically enabled for non-localhost connections.",
      "  To override: PGSSLMODE=disable or ?sslmode=disable in URL",
      "",
